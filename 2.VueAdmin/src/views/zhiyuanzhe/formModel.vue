				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="志愿者密码" prop="zhiyuanzhemima">
							<el-input class="list_inp" v-model="form.zhiyuanzhemima" placeholder="志愿者密码"
								type="password" :readonly="!isAdd||disabledForm.zhiyuanzhemima?true:false" />
						</el-form-item>
					</el-col>
					<el-col :span="24">
					...
					<el-col :span="12">
						<el-form-item label="服务项目" prop="fuwuxiangmu">
							<el-input v-model="form.fuwuxiangmu" placeholder="服务项目" type="textarea"
							:readonly="!isAdd||disabledForm.fuwuxiangmu?true:false"
							/>
						</el-form-item>
					</el-col>
				</el-row>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='zhiyuanzhemima'){
					form.value.zhiyuanzhemima = row[x];
					disabledForm.value.zhiyuanzhemima = true;
					continue;
				}
				if(x=='tupian'){
