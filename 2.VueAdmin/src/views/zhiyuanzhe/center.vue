				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="志愿者账号" prop="zhiyuanzhezhanghao">
							<el-input class="list_inp" v-model="user.zhiyuanzhezhanghao" readonly placeholder="志愿者账号" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="志愿者密码" prop="zhiyuanzhemima">
							<el-input class="list_inp" v-model="user.zhiyuanzhemima" readonly placeholder="志愿者密码" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="图片" prop="tupian">
							<uploads
								...
								@change="zhiyuanzhetupianUploadSuccess">
							</uploads>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="志愿者姓名" prop="zhiyuanzhexingming">
							<el-input class="list_inp" v-model="user.zhiyuanzhexingming"  placeholder="志愿者姓名" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="性别" prop="xingbie">
							<el-select 
								...
								placeholder="请选择性别"
								>
								<el-option v-for="item in zhiyuanzhexingbieLists" :label="item" :value="item"></el-option>
							</el-select>
						</el-form-item>
					</el-col>
					<el-col :span="12">
					...
					<el-col :span="12">
						<el-form-item label="服务时间" prop="fuwushijian">
							<el-input class="list_inp" v-model="user.fuwushijian"  placeholder="服务时间" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="服务项目" prop="fuwuxiangmu">
							<el-input class="list_inp" v-model="user.fuwuxiangmu"  placeholder="服务项目" clearable />
						</el-form-item>
					</el-col>
...
<script setup>
	...
	const tableName = ref('zhiyuanzhe')
	const user = ref({})
	const zhiyuanzhexingbieLists = ref([])
	const init = () => {
		zhiyuanzhexingbieLists.value = "男,女".split(',')
	}
	const zhiyuanzhetupianUploadSuccess=(fileUrls)=> {
	    user.value.tupian = fileUrls;
	}
	const onSubmit = () => {
		if((!user.value.zhiyuanzhezhanghao)){
			context?.$toolUtil.message(`志愿者账号不能为空`,'error')
			return false
		}
		if((!user.value.zhiyuanzhemima)){
			context?.$toolUtil.message(`志愿者密码不能为空`,'error')
			return false
		}
		if(user.value.tupian!=null){
			user.value.tupian = user.value.tupian.replace(new RegExp(context?.$config.url,"g"),"");
		}
		if((!user.value.zhiyuanzhexingming)){
			context?.$toolUtil.message(`志愿者姓名不能为空`,'error')
			return false
		}
