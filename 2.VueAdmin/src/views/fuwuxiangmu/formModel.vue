				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="预约须知" prop="yuyuexuzhi">
							<el-input v-model="form.yuyuexuzhi" placeholder="预约须知" type="textarea"
							:readonly="!isAdd||disabledForm.yuyuexuzhi?true:false"
							/>
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="服务内容" prop="fuwuneirong">
							<editor :value="form.fuwuneirong" placeholder="请输入服务内容" :readonly="!isAdd||disabledForm.fuwuneirong?true:false"
								class="list_editor" @change="(e)=>editorChange(e,'fuwuneirong')"></editor>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.fuwuneirong = res.data.data.fuwuneirong?(res.data.data.fuwuneirong.replace(reg,'../../../cl54995152/file')):'';
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='fuwuneirong'){
					form.value.fuwuneirong = row[x];
					disabledForm.value.fuwuneirong = true;
					continue;
				}
				if(x=='storeupnum'){
